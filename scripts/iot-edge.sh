...
DeviceConfigName=$5
TenantID=$6
AzurePortalUsername=$7
AzurePortalPassword=$8
SubscriptionID=$9
...
az login -u $AzurePortalUsername -p $AzurePortalPassword -tenant $TenantID
...
wget $DeviceConfig
az iot hub apply-configuration -n $IoThubName -d $DeviceName -k $DeviceConfigName
